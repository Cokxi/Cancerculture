...
test("the registry preserves eighteen known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 18);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 16);
  assert.equal(
