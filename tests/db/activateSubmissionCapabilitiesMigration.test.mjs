...
test("the registry preserves twenty-one known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 21);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 19);
  assert.equal(
