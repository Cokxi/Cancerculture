...
test("the registry preserves nineteen known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 19);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 17);
  assert.equal(
