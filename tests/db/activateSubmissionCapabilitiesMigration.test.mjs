...
test("the registry preserves twenty-seven known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 27);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 25);
  assert.equal(
