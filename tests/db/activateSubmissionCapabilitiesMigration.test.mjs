...
test("the registry preserves sixteen known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 16);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 14);
  assert.equal(
