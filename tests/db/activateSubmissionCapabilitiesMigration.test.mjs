...
test("the registry preserves twenty known definitions after later cutovers", () => {
  assert.equal(REGISTERED_TEAM_CAPABILITY_KEYS.length, 20);
  assert.equal(ACTIVE_TEAM_CAPABILITY_KEYS.length, 18);
  assert.equal(
