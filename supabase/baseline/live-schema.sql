...
CREATE VIEW public.submissions_with_votes WITH (security_invoker='on') AS
 SELECT s.id,
    s.cycle_id,
    s.discord_user_id,
    s.is_disqualified,
...
GRANT ALL ON FUNCTION public.apply_discord_live_event(p_event_id text, p_event_type text, p_observed_at timestamp with time zone, p_payload_sha256 text, p_discord_user_id text, p_discord_username text) TO service_role;
...
GRANT ALL ON FUNCTION public.audit_discord_sync_action(p_action text, p_discord_user_id text, p_meta jsonb) TO service_role;
...
GRANT ALL ON FUNCTION public.claim_discord_membership_sync_event(p_event_id text, p_event_type text, p_observed_at timestamp with time zone, p_payload_sha256 text) TO service_role;
...
GRANT ALL ON FUNCTION public.enforce_discord_authenticated_action() TO service_role;
...
GRANT ALL ON FUNCTION public.enforce_discord_ban_submissions(p_discord_user_id text, p_observed_at timestamp with time zone, p_source text) TO service_role;
...
GRANT ALL ON FUNCTION public.enforce_discord_ban_submissions_trigger() TO service_role;
...
GRANT ALL ON FUNCTION public.enforce_submission_upload_abuse_block() TO service_role;
...
GRANT ALL ON FUNCTION public.finalize_cycle(p_cycle_id bigint, p_actor_discord_user_id text) TO anon;
GRANT ALL ON FUNCTION public.finalize_cycle(p_cycle_id bigint, p_actor_discord_user_id text) TO authenticated;
...
GRANT ALL ON FUNCTION public.finish_discord_membership_sync_event(p_event_id text, p_result_status text) TO service_role;
...
GRANT ALL ON FUNCTION public.process_due_cycle_transitions(p_cycle_id bigint) TO anon;
GRANT ALL ON FUNCTION public.process_due_cycle_transitions(p_cycle_id bigint) TO authenticated;
...
GRANT ALL ON FUNCTION public.protect_discord_ban_republish() TO service_role;
...
GRANT ALL ON FUNCTION public.reset_cycle(p_cycle_id bigint, p_actor_discord_user_id text, p_reason text) TO anon;
GRANT ALL ON FUNCTION public.reset_cycle(p_cycle_id bigint, p_actor_discord_user_id text, p_reason text) TO authenticated;
GRANT ALL ON FUNCTION public.reset_cycle(p_cycle_id bigint, p_actor_discord_user_id text, p_reason text) TO service_role;


--
-- Name: FUNCTION reset_social_verification_on_change(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.reset_social_verification_on_change() TO anon;
GRANT ALL ON FUNCTION public.reset_social_verification_on_change() TO authenticated;
GRANT ALL ON FUNCTION public.reset_social_verification_on_change() TO service_role;


--
-- Name: FUNCTION set_user_logs_updated_at(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.set_user_logs_updated_at() TO anon;
GRANT ALL ON FUNCTION public.set_user_logs_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.set_user_logs_updated_at() TO service_role;
...
GRANT ALL ON FUNCTION public.start_cycle(p_cycle_id bigint, p_actor_discord_user_id text, p_settings jsonb) TO anon;
GRANT ALL ON FUNCTION public.start_cycle(p_cycle_id bigint, p_actor_discord_user_id text, p_settings jsonb) TO authenticated;
...
REVOKE ALL ON FUNCTION public.sync_discord_user_context(p_discord_user_id text, p_discord_handle text, p_display_name text, p_guild_nickname text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.sync_discord_user_context(p_discord_user_id text, p_discord_handle text, p_display_name text, p_guild_nickname text) TO service_role;
