-- LIVE catch-up package B: Discord, sessions, and Ban enforcement
-- Reviewed extraction from migrations 20260715000600 and 20260716000200.
-- Upload-operation trigger is deferred to package D; final Vote RPC is deferred to package C.
...
-- Deferred: submission_upload_operations_discord_access_trigger is created in package D after its table exists.
...
-- Deferred: final cast_cycle_vote definition is installed by package C after Cycle columns and Vote uniqueness exist.
